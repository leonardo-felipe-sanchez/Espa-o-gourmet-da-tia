      ...
      return (
        ...
        >
          ...
          {formular.formulario.inputs.map((campo, index) => {
            const condicionalInput =
             [
              ...
              ((campo.id === "email" && formularioParticionado === 0) ||
              (campo.id === "password" && formularioParticionado === 0) ||
              (campo.id === "confirmPassword" && formularioParticionado === 0) ||
              (campo.id === "nome" && formularioParticionado === 1) ||
              (campo.id === "cpf" && formularioParticionado === 1) ||
              (campo.id === "idade" && formularioParticionado === 1) ||
              (campo.id === "genero" && formularioParticionado === 1) ||
              (campo.id === "telefone" && formularioParticionado === 1) ||
              (campo.id === "cep" && formularioParticionado === 2) ||
              (campo.id === "rua" && formularioParticionado === 2) ||
              (campo.id === "numero" && formularioParticionado === 2) ||
              (campo.id === "complemento" && formularioParticionado === 2)) ||
              (campo.id === "pontoReferencia" && formularioParticionado === 3) ||
              (campo.id === "bairro" && formularioParticionado === 3) ||
              (campo.id === "cidade" && formularioParticionado === 3)
             ]
            ...
            return (
              (
                <Input
                  ...
                  placeholder={campo.placeholder}
                  defaultValue={campo.defaultValue}
                  classe={`${campo.classe} ${condicionalInput[0] || condicionalInput[1] ? "block" : "hidden"}`}
          ...
          <div className="flex gap-4 mt-4">
            ...
            <button
              type={formularioParticionado === 3 ? "submit" : "button"}
              onClick={() => {
            ...
            >
              {formularioParticionado === 3 ? "Enviar" : "continuar"}
            </button>
          </div>
        </Form>
      );
