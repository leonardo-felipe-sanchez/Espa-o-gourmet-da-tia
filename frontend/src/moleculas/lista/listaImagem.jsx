export const listaImagem = [
  {
    imagem: (
      <svg xmlns="http://www.w3.org/2000/svg" className="size-12" viewBox="0 0 640 640">
        <path
          fill="currentColor"
    ...
    recurso: "#face",
    classe: "hover:text-white hover:bg-pink-500 text-pink-500 size-17 border border-pink-500 rounded-full flex items-center justify-center",
    como: "svg",
  },
  {
    imagem: (
